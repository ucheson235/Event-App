  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-6">
      <div className="bg-[#041e23] rounded-[40px] border border-[#0e464f] w-full max-w-screen-lg min-h-[600px] px-6 py-4 sm:px-10">
        ...
        >
          <div className="ticket-container text-white bg-transparent rounded-[40px] border-2 border-[#0e464f] w-full max-w-[350px] min-h-[200px] m-3 text-center bg-[radial-gradient(closest-side,rgba(36,160,181,0.2)_0%,rgba(36,160,181,0)_100%),linear-gradient(to_left,rgba(10,12,17,0.1),rgba(10,12,17,0.1))]">
